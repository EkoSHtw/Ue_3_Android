...
public class GraphView2 extends View {
    ...
    public GraphView2 (Context context, float[] values, String title, String[] str,String[] verlabels, boolean type) {
        ...
        //return new GraphView(getContext());
    }
    ...
    public GraphView2(Context context, @androidx.annotation.Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public GraphView2(Context context, @androidx.annotation.Nullable AttributeSet attrs, int defStyleAttr) {
